...
public class FindKClosestElements {
    public static void main(String[] args) {
        int[] nums = {0,0,1,1,1,2,2,2,2,3,4,5,5,6,6,6};
        System.out.println(findKClosestElements(nums, 4,3));
    }
    ...
    private static void addRemaning(List<Integer> res, int[] nums, int pos, int count, int x) {
        if (count == 0) return;
        int left = pos - 1;
        int right = pos + 1;
