...
public class FindKClosestElements {
    ...
    public static void main(String[] args) {
        int[] nums = {1,2,3,3,4,4,5,5,5,6,6,7};
        System.out.println(findKClosest(nums, 3, 5));
        System.out.println(findKClosest(nums, 3, 6));
        System.out.println(findKClosest(nums, 3, 1));
    }
}
